    ...
    describe "when given an RSS feed without ParlyCal markup" do
      ...
      describe "when parsing a House of Commons item" do
        before :each do
          ...
          RssItem.should_receive(:new).and_return(@rssitem)
        ...
        it "sets the 'chamber' for the RssItem" do
          @rssitem.should_receive(:chamber=).at_least(1).times.with("Westminster Hall")
        ...
        it "should not set the 'committee' for the RssItem" do
          @rssitem.should_not_receive(:committee=)
        ...
        it "should set the 'subject' for the RssItem" do
          @rssitem.should_receive(:subject=).with("House of Commons Westminster Hall - Chi Onwurah")
        ...
        it "should set the 'inquiry' for the RssItem" do
          @rssitem.should_receive(:inquiry=).with("House of Commons Westminster Hall - Chi Onwurah")
        ...
        it "should set the 'note' for the RssItem" do
          @rssitem.should_receive(:notes=).with("Friday 24 February 2012 - 9:30am - 11:00am <br /> Health inequalities in the North East today")
        ...
        it "sets the 'date' for the RssItem" do
          @rssitem.should_receive(:date=).with("2012-02-24")
        ...
        it "sets the 'start time' for the RssItem (if there is one)" do
          @rssitem.should_receive(:start_time=).with("9:30am")
        ...
        it "sets the 'end time' for the RssItem (if there is one)" do
          @rssitem.should_receive(:end_time=).with("11:00am")
        ...
        it "sets the 'sponsor' for the RssItem (if there is one)" do
          @rssitem.should_receive(:sponsor=).with("Chi Onwurah")
        ...
        it "sets the 'category' for the RssItem (if there is one)" do
          @rssitem.should_not_receive(:category=)
